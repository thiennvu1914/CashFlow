...
export default async function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4 sm:items-start sm:pt-[12vh]">
      ...
      <main className="card-hover-effect flex w-full max-w-[25rem] flex-col gap-6 rounded-2xl border border-border/80 bg-surface/95 p-6 shadow-md backdrop-blur-md sm:p-8">
