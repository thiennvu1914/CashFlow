...
function createPrismaClient() {
  ...
  // production, a warning in development) before the first connection is made.
  // `DATABASE_URL` is read back from the validated contract so this factory and
  // `lib/server/env.ts` cannot disagree about what counts as configured.
